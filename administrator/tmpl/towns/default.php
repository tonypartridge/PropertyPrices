...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_xws_property&task=towns.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_('index.php?option=com_xws_property&view=towns'); ?>" method="post"
	...
	<div class="row">
		<div class="col-md-12">
			<div id="j-main-container" class="j-main-container">
				...
				<table class="table table-striped" id="townList">
					<thead>
					<tr>
						<th width="1%" >
				...
				<?php echo HTMLHelper::_('searchtools.sort',  'COM_XWS_PROPERTY_TOWNS_NAME', 'a.name', $listDirn, $listOrder); ?>
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<?php if (isset($this->items[0]->state)): ?>
								<td class="center">
								<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'towns.', $canChange, 'cb'); ?>
</td>
							<?php endif; ?>
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'towns.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo Route::_('index.php?option=com_xws_property&task=town.edit&id='.(int) $item->id); ?>">
