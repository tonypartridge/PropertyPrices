...
class TownModel extends AdminModel
{
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_xws_property.town';
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'Town', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_xws_property.edit.town.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = Factory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__xws_property_towns');
				$max             = $db->loadResult();
